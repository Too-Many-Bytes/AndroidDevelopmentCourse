...
import com.example.myapplication8.databinding.NewAppWidgetConfigureBinding;
        ...
        if (extras != null)
        {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    views.setOnClickPendingIntent(R.id.appwidget_text, pending); widgetManager.updateAppWidget(widgetID, views);
